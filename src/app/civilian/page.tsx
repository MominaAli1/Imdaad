...
import { useImdaadStore } from '@/lib/store';
...
const ImdaadMap = dynamic(() => import('@/components/maps/ImdaadMap'), {
  ssr: false,
          ...
          >
            ...
            <div className="relative z-10 max-w-sm w-full text-center space-y-8">
              ...
              <div className="space-y-4">
                ...
                >
                  {phase === 'completed' 
                    ? 'Thank you for choosing Imdaad. Your emergency has been marked as completed by the responders.'
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-1 mb-0.5">
                    <Image src="/logoBackgroundRemoved.png" alt="Imdaad" width={36} height={36} className="rounded-lg shadow-sm" priority />
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 relative z-10">
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="text-xs text-gray-400 mt-4">
                  {store.agentStatus === 'idle' ? 'Tap to call Imdaad AI' : ''}
                </p>
              </div>
        ...
        <div className="absolute top-0 left-0 right-0 p-4 pt-10 z-[1000]">
          <div className="flex items-center gap-1.5">
            <div className="w-7 h-7 relative">
              <Image src="/logoBackgroundRemoved.png" alt="Imdaad" fill className="object-contain" />
            </div>
            <span className="text-sm font-bold bg-clip-text text-transparent bg-gradient-to-br from-orange-600 to-orange-400">Imdaad</span>
            <motion.div
