...
export default function EmergencyCall({
  ...
  const startCall = useCallback(async () => {
    ...
    try {
      ...
      // Speak first message
      await speak('Imdaad Emergency. Kya hua hai?');
        ...
        {!isCallActive && !isConnecting ? (
          ...
          >
            ...
            <div className="text-left">
              <div className="text-sm font-semibold text-zinc-800">Imdaad AI se baat karein</div>
            ...
            <div className="px-4 py-2.5 flex items-center justify-between border-b border-zinc-800">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-zinc-300">
                  {isConnecting ? 'Connecting...' : isListening ? 'Sun raha hai...' : isSpeaking ? 'Bol raha hai...' : 'Imdaad AI · Live'}
                </span>
              </div>
