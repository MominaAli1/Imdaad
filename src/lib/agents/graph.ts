// ============================================================
// Imdaad v2 — LangGraph Emergency Response Pipeline
...
// ── State ────────────────────────────────────────────────────
const ImdaadState = Annotation.Root({
...
export type ImdaadStateType = typeof ImdaadState.State;

// ── NODE 1: INTAKE — Parse transcript via Groq ──────────────
async function intakeNode(state: ImdaadStateType): Promise<Partial<ImdaadStateType>> {
...
async function geocodeNode(state: ImdaadStateType): Promise<Partial<ImdaadStateType>> {
...
async function brokerNode(state: ImdaadStateType): Promise<Partial<ImdaadStateType>> {
...
async function pivotNode(state: ImdaadStateType): Promise<Partial<ImdaadStateType>> {
...
async function patchNode(_state: ImdaadStateType): Promise<Partial<ImdaadStateType>> {
...
// ── ROUTING ──────────────────────────────────────────────────
function routeAfterPivot(state: ImdaadStateType): string {
...
// ── BUILD ────────────────────────────────────────────────────
export function buildImdaadGraph() {
  const graph = new StateGraph(ImdaadState)
