# Imdaad — AI Emergency Response System for Karachi
...
Built by Momina Ali 30579 & Javeria Khan 31662 — a production-grade emergency response broker powered by LangGraph orchestration, Groq Whisper STT, and WebRTC voice communication.
...
The Broker node is the only place in Imdaad where a *classical AI* algorithm is the load-bearing decision-maker. It uses **A\* search** (Hart, Nilsson & Raphael, 1968) to choose which available institute should receive the emergency broadcast. This replaces a naive nearest-neighbour reduce that ignored the road network's topology.
...
| **CSP / Genetic** | Better fit for *multi-incident* assignment problems. | Out of scope — Imdaad currently dispatches one incident at a time |
...
│   ├── maps/
│   │   └── ImdaadMap.tsx                 # MapLibre map with route lines
...
| Feature | Traditional 1122/911 | Imdaad |
|---------|----------------------|--------|
...
Momina Ali 30579 & Javeria Khan 31662
